...
6. **Final Report** — `REPORT.pdf` or `REPORT.pdf` (must include required sections below)
...
- **Project Proposal** — upload to portal & push initial GitHub repo — **8 Sep**
...
- **Intermediate Report & Code** — full code + draft results + AI tool reflections — **20 Oct**
- **Final Report & Code (publish)** — `REPORT.md` or `REPORT.pdf`, push to GitHub — **8 Nov**
...
- Fill `metadata.yaml` with an `entrypoint` command; the grader/TA will run that command to produce outputs.

## Academic integrity
- Declare all AI/tools/external code in `REPORT.md` and in PR descriptions.
